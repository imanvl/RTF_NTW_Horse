...
function M_cimi = cimcode(M, Assets, Liabilities, E, TA, Ensemble)
...
options=optimset('Display','iter','Algorithm','trust-region-reflective','Jacobian','on','MaxIter',10^5,'TolX',10^(-32),'TolFun',10^(-32));
