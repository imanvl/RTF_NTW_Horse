...
% Last Modified by GUIDE v2.5 24-May-2013 15:21:34
...
global iter iter_max
set(handles.text1,'Position',[10.108000000000004 3.146153846153848 (79.584/iter_max)*iter 1.385]);
set(handles.uipanel1,'Title',sprintf('%d %% ',round(iter*100/iter_max)));
guidata(hObject,handles);
if iter==iter_max
close
end
