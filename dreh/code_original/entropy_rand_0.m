function [Mat Eval]=entropy_rand_0(Asset,Liab,Nrand, S,U)
...
% 4. col number of zeros off the diagonal, 5. col is 0 if oncvergence
% otherwise 100.
%
% Input: 
...
% Can create sink bank if total interbank deposits are not equal to total interbank assets
% for banks in systemc (here crucial that r assets and c liabilities)
% randomized interlinkages

%% Setting
I=100;                                             % Maximum number of iterations

Min=1;              %if random number below Min, counterparty expopsure between banks is set to 0.
%%  ============= Checking inputs =============
% Single matrix
