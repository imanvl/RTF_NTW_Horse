...
for a = approachesList
    ...
    outputMatrices.(technique).MeanHHIAsset = herfindhalIndexAsset_mean;        % Newly reported values
    outputMatrices.(technique).MedianHHIAsset = herfindhalIndexAsset_median;    % Newly reported values
    outputMatrices.(technique).MeanHHILiab = herfindhalIndexLiab_mean;          % Newly reported values
    outputMatrices.(technique).MedianHHILiab = herfindhalIndexLiab_median;      % Newly reported values
    ...
    clear('A','Links','Density','MeanDeg','MedoDeg','SymPearson','LendDep',...
        ...
        'herfindhalIndexAsset_mean','herfindhalIndexAsset_median',...           % Newly reported values
        'herfindhalIndexLiab_mean','herfindhalIndexLiab_median',...             % Newly reported values
