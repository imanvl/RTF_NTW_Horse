...
for i = 1 : length(methods)
    ...
    for j = 1 : length(similarityList)
        ...
        xlswrite(...
            filename,...
            quantile(outputMatrices.(technique).similarity.(metric),0.1),...
            sheet,...
            xlRange)
    end
end
...
for i = 1 : length(methods)
    ...
    for j = 1 : length(confusionMatrixList)
        ...
        xlswrite(...
            filename,...
            quantile(outputMatrices.(technique).confusionMatrix.(metric),0.1),...
            sheet,...
            xlRange)
    end
end
...
for i = 1 : length(methods)
    ...
    for j = 1 : length(debtRankList)
        ...
        xlswrite(...
            filename,...
            quantile(1 * outputMatrices.(technique).(metric),0.1),...
            sheet,...
            xlRange)
    end
end